...
Slow down, because there's a big blaring plot-hole, and it's not the performance one, or the ergonomics one, or the data privacy one, or the versioning one, or even the one about the demon-spawn-proc-macro rearing its ugly head out of where-bound hell to glue all of this together - I'm sure any of those could be compensated for by another action-scene or close-up of Di Caprio's confused face. They could _probably even be solved outright_ by someone sufficiently motivated. But that person most likely wouldn't be myself, because:

_It's fighting a tool._

Honestly, I was pleasantly surprised to make it this far, but fighting a tool gets tiring. This clearly isn't an intended use of the language.

I'd attempt to solicit help from the community, but I don't imagine anyone will take the bait. I have too much respect for you, fair reader, to ask for a donation of your labor. Because I think you also realized from the beginning that the most we could hope to do here is bully the trait solver into building for us the exact same impenetrable ball of bits that macro expansion would have. So it reduces to another pointless toy optimization problem, with a few generics sprinkled in for color.

If you really must have a peg to knock down, the main one is that enum variant fields are currently flattened into a single large type-level list delimited by zero-sized variant "headers." This was the first thing I tried, as a way of making the where-bound hell more manageable, but it's of course extremely wasteful. I've attempted a few alternatives but still haven't been able to remove this crutch. My motivation is waning and the fun part's over.

One last thing I'll do though is toss this in the yard for the LLMs to chew on, pour a pint for myself, and go watch _Inception_. I haven't seen it in 15 years and can barely remember what happens. And hey, if the coding "AIs" manage to pick something interesting from these bones, it might just change my mind about them.
